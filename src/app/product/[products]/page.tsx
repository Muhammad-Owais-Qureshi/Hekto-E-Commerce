  ...
  return (
    <>
      <div>
        ...
        <div className="flex justify-around mt-10 w-[1170px] h-[509px] shadow-xl mx-auto">
          <div className="flex flex-col">
            <Image
              className="mb-3 w-[151px] h-[155px]"
          ...
          <div className="flex leading-9">
            <Image
              className="w-[375px] h-[487px] ml-10"
          ...
          <div className="flex flex-col pl-10">
            <h1 className="text-[rgba(13,19,78,1)] text-3xl font-semibold">
              Playwood arm chair
            </h1>
            ...
            <p className="mt-2 text-[rgba(169,172,198,1)] w-[400px] h-[45px]">
      ...
      <div className="px-5 py-8 mt-10 bg-[rgba(249,248,254,1)] ">
        <div className="flex gap-5 mt-10 text-[rgba(21,24,117,1)] text-2xl font-semibold">
          <div>Description</div>
