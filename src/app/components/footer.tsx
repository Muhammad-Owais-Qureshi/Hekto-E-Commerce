...
const Footer = () => {
  return (
    <div className='mt-10 bg-[rgba(238,239,251,1)] flex flex-col pt-5 pl-4 w-[360px] md:h-[479px] md:w-[1350px] md:px-16 md:flex md:flex-row md:gap-24 md:pt-14'>
        <div>
            <div className=''>
                <h1 className='w-[110px] h-[38px] mt-3 text-[rgba(0,0,0,1)] font-bold text-3xl'>Hekto</h1>
                <div className=' mt-5'>
                <input type="search" placeholder='Enter Your Address' className='bg-[rgba(255,255,255,1)] h-[44px] md:w-[377px] w-[330px] pl-0 md:pl-5' />
